...
if torch.cuda.is_available():
    ...
    print("Warning: CUDA is not available. Training will run on CPU and be potentially very slow.")
...
# 学习率，理解为迈的步子大小，1e-5现在太慢了，改为1e-3
max_epochs = 4
val_interval = 1
...
# # 自定义设置y轴刻度
# tick_positions = np.arange(0.9984,1.0002,0.0002)
